...
export function MainLayout({ children }: MainLayoutProps) {
  ...
  return (
    <div className="nb-app-shell flex min-h-screen flex-col overflow-hidden">
      ...
      {showFikriLauncher && (
        <button
          className="fixed z-[150] flex flex-col items-center gap-2 transition-transform duration-150 hover:scale-105 active:scale-95"
        ...
        >
          <img
            src={fikriImage}
            alt="فكري"
            className="h-14 w-14 rounded-[22px] border-[3px] border-black/90 object-cover shadow-[6px_6px_0_0_rgba(0,0,0,0.88)] sm:h-16 sm:w-16"
            draggable={false}
          />
          <span className="rounded-full border-[3px] border-black/90 bg-primary px-3 py-1 text-[10px] font-black text-primary-foreground shadow-[4px_4px_0_0_rgba(0,0,0,0.88)] sm:text-xs">
            فكري 2
          </span>
        </button>
      )}
