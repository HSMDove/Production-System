...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-[24px] border-[3px] border-black/90 bg-card p-2 text-muted-foreground shadow-[4px_4px_0_0_rgba(0,0,0,0.86)]",
      className
    )}
    {...props}
  />
